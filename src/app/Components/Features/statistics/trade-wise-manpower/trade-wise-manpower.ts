...
export class TradeWiseManpowerComponent implements OnInit, OnDestroy {
     ...
     *  corps-wise and unit-rank-wise reports. */
    ...
    private applyDefaultMergeSelection(): void {
        ...
        const wanted = new Set(
            TradeWiseManpowerComponent.DEFAULT_MERGE_MEMBER_TYPE_NAMES.map((n) => n.trim().toLowerCase())
        );
    ...
    onOrgFilterChange(): void {
        ...
        const fetchOrg = (id: number) =>
            this.showMotherOrgRank
                ? this.statisticsService.getTradeWiseManpower(id, undefined, this.filterRabCodeId, this.selectedMergeMemberTypeIds)
                : this.statisticsService.getTradeWiseManpowerByEquivalentName(id, undefined, this.filterRabCodeId, this.selectedMergeMemberTypeIds);

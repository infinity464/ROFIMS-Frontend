...
export class ReportStayAfterRelieverJoinedComponent implements OnInit {
    ...
    private static readonly colKeyToBackend: Record<string, string> = {
        ...
        serviceId: 'serviceId', joiningInRab: 'joiningInRab', presentUnit: 'presentUnit',
        postedOutUnit: 'postedOutUnit', relieverJoiningDate: 'relieverJoiningDate', rmks: 'rmks',
    };
    ...
    private loadPage(): void {
        ...
        const columns = Array.from(new Set([
            ...this.selectedColumnKeys.map(k => ReportStayAfterRelieverJoinedComponent.colKeyToBackend[k] ?? k),
            'joiningInRab',
        ]));

...
export class ReportMovementComponent implements OnInit {
    ...
    columnCatalog: { key: string; labelEN: string; labelBN: string; hint: 'Serial' | 'Personnel' | 'Date' | 'Plain' | 'Returned' | 'Remarks'; defaultVisible: boolean }[] = [
    ...
    private loadPage(): void {
        ...
        const columns = Array.from(new Set(this.selectedColumnKeys.map((k) => ReportMovementComponent.colKeyToBackend[k] ?? k)));
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    tbody td { padding: 2mm 2mm; font-size: 8pt; color: #0b0b0b; border: 1px solid rgba(11,11,11,0.05); vertical-align: top; background: #fff; word-break: normal; overflow-wrap: break-word; }

...
export class ReportPresentStatusComponent implements OnInit {
    ...
    columnCatalog: { key: string; labelEN: string; labelBN: string; hint: 'Serial' | 'Personnel' | 'Date' | 'Plain' | 'Remarks'; defaultVisible: boolean }[] = [
        ...
        { key: 'statusDate', labelEN: 'Status Date', labelBN: 'অবস্থার তারিখ', hint: 'Date', defaultVisible: true },
        { key: 'statusDetails', labelEN: 'Status Details', labelBN: 'বিবরণ', hint: 'Plain', defaultVisible: true },
    ...
    private loadPage(): void {
        ...
        const columns = Array.from(new Set([...this.selectedColumnKeys.map((k) => ReportPresentStatusComponent.colKeyToBackend[k] ?? k), 'presentStatus', 'statusDate']));

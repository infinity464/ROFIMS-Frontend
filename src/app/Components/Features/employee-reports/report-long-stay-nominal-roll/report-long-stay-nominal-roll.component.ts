...
export class ReportLongStayNominalRollComponent implements OnInit, OnDestroy {
    lang: Lang = 'en';
    ...
    private loadPage(): void {
        ...
        if (this.selectedRabRankId != null && this.selectedRabRankId > 0)
            criteria.push({ fieldKey: 'rabRankEquivalent', idValue: this.selectedRabRankId });

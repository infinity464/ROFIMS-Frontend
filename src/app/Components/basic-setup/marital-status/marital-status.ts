...
export class MaritalStatus {
    ...
    formConfig: FormConfig = {
        formFields: [
            {
                name: 'codeValueEN',
                label: 'Marital Status Name (English)',
                type: 'text',
                required: true
            },
            {
                name: 'codeValueBN',
                label: 'Marital Status Name (Bangla)',
                type: 'text',
                required: true
            },
            {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Marital Status Name (EN)' },
            { field: 'codeValueBN', header: 'Marital Status Name (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'MaritalStatus deleted successfully'
                        });
                    },
                    error: (err) => {

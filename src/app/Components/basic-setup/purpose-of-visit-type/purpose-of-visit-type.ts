...
@Component({
    selector: 'app-purpose-of-visit-type',
    imports: [DynamicFormComponent, DataTable, Fluid],
    templateUrl: './purpose-of-visit-type.html',
    providers: [],
    styleUrl: './purpose-of-visit-type.scss'
})
export class PurposeOfVisitType {
    codeType: string = 'PurposeOfVisitType';
    title: string = 'Purpose of Visit Type';
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Purpose of Visit (EN)' },
            { field: 'codeValueBN', header: 'Purpose of Visit (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
        ...
        this.masterBasicSetupService.create(createPayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Purpose of Visit Type created successfully'
                });
            },
            error: (err) => {
        ...
        this.masterBasicSetupService.update(updatePayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Purpose of Visit Type updated successfully'
                });
                this.isSubmitting = false;
            },
            error: (err) => {
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'Purpose of Visit Type deleted successfully'
                        });
                    },
                    error: (err) => {

...
export class Occupation {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Occupation Name (EN)' },
            { field: 'codeValueBN', header: 'Occupation Name (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'Occupation deleted successfully'
                        });
                    },
                    error: (err) => {

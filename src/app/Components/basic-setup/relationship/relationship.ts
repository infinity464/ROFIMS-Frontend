...
export class Relationship {
    ...
    formConfig: FormConfig = {
        formFields: [
            {
                name: 'codeValueEN',
                label: 'Relationship Name (English)',
                type: 'text',
                required: true
            },
            {
                name: 'codeValueBN',
                label: 'Relationship Name (Bangla)',
                type: 'text',
                required: true
            },
            {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Relationship Name (EN)' },
            { field: 'codeValueBN', header: 'Relationship Name (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',

...
@Component({
    selector: 'app-education-institution-type',
    imports: [DynamicFormComponent, DataTable, ConfirmDialog, Toast, Fluid],
    templateUrl: './education-institution-type.html',
    providers: [MessageService, ConfirmationService],
    styleUrl: './education-institution-type.scss'
})
export class EducationInstitutionType {
    codeType: string = 'EducationInstitutionType';
    ...
    formConfig: FormConfig = {
        formFields: [
            {
                name: 'codeValueEN',
                label: 'Educational Board \ University Type Name (English)',
                type: 'text',
                required: true
            },
            {
                name: 'codeValueBN',
                label: 'Educational Board \ University Type Name (Bangla)',
                type: 'text',
                required: true
            },
            {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Educational Board \ University Type Name (EN)' },
            { field: 'codeValueBN', header: 'Educational Board \ University Type Name (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'EducationInstitutionType deleted successfully'
                        });
                    },
                    error: (err) => {

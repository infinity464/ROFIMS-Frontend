...
@Component({
    ...
    templateUrl: './education-result.html',
    providers: [MessageService, ConfirmationService],
    styleUrl: './education-result.scss'
})
export class EducationResult {
    codeType: string = 'EducationResult';
    title: string = 'Education Result';
    ...
    formConfig: FormConfig = {
        formFields: [
            {
                name: 'codeValueEN',
                label: 'Education Result Name (English)',
                type: 'text',
                required: true
            },
            {
                name: 'codeValueBN',
                label: 'Education Result Name (Bangla)',
                type: 'text',
                required: true
            },
            {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Education Result Name (EN)' },
            { field: 'codeValueBN', header: 'Education Result Name (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
        ...
        this.masterBasicSetupService.create(createPayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Education Result created successfully'
                });
        ...
        this.masterBasicSetupService.update(updatePayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Education Result updated successfully'
                });
                this.isSubmitting = false;
            },
            error: (err) => {
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'Education Result deleted successfully'
                        });
                    },
                    error: (err) => {

...
@Component({
    selector: 'app-brief-statement-of-offence',
    imports: [DynamicFormComponent, DataTable,   Fluid],
    templateUrl: './brief-statement-of-offence.html',
    providers: [],
    styleUrl: './brief-statement-of-offence.scss'
})
export class BriefStatementOfOffence {
    codeType: string = 'BriefStatementOfOffence';
    title: string = 'Brief Statement of Offence';
    ...
    formConfig: FormConfig = {
        formFields: [
            {
                name: 'codeValueEN',
                label: 'Brief Statement of Offence (English)',
                type: 'text',
                required: true
            },
            {
                name: 'codeValueBN',
                label: 'Brief Statement of Offence (Bangla)',
                type: 'text',
                required: true
            },
            {
    ...
    tableConfig: TableConfig = {
        tableColumns: [
            { field: 'codeValueEN', header: 'Brief Statement of Offence (EN)' },
            { field: 'codeValueBN', header: 'Brief Statement of Offence (BN)' },
            {
                field: 'status',
                header: 'Status',
                type: 'boolean',
        ...
        this.masterBasicSetupService.create(createPayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Brief Statement of Offence created successfully'
                });
            },
            error: (err) => {
        ...
        this.masterBasicSetupService.update(updatePayload).subscribe({
            next: (res) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: 'Brief Statement of Offence updated successfully'
                });
                this.isSubmitting = false;
            },
            error: (err) => {
                ...
                this.masterBasicSetupService.delete(row.codeId).subscribe({
                    next: () => {
                        ...
                        this.messageService.add({
                            severity: 'success',
                            summary: 'Success',
                            detail: 'Brief Statement of Offence deleted successfully'
                        });
                    },
                    error: (err) => {
